...
////		 Assert.assertEquals( homePage, "https://github.com/password_reset");
////		 
//		 
//	 }
//	 @Test
...
//	 homepage1 = driver.getCurrentUrl();
//	 Assert.assertEquals( homepage1, "https://github.com/signup?source=login");
//	 
//	 }
...
//		 homepage2 = driver.getCurrentUrl();
//		 Assert.assertEquals( homepage2, "https://docs.github.com/en/github/site-policy/github-terms-of-service");
//	 }	 
		 
//	 @Test
//		public void CheckTransititonTC20() {
//		 driver.findElement(By.xpath("//a[contains(text(),'Privacy')]")).click();	
//		 homepage3 = driver.getCurrentUrl();
//		 Assert.assertEquals( homepage3, "https://docs.github.com/en/github/site-policy/github-privacy-statement");
//	 }
//	 
//	 @Test
//		public void CheckTransititonTC21() {
//		 driver.findElement(By.xpath("//a[contains(text(),'Security')]")).click();	
//		 homepage4 = driver.getCurrentUrl();
//		 Assert.assertEquals( homepage4, "https://github.com/security");
//	 }	 	
		 
//	 @Test
//		public void CheckTransititonTC22() {
//		 driver.findElement(By.xpath("//a[contains(text(),'Contact GitHub')]")).click();
//		 homepage5 = driver.getCurrentUrl();
//		 Assert.assertEquals( homepage5, "https://support.github.com/request");
//	 }	 	 
...
////		CheckLogin =  driver.findElement(By.xpath("//body/div[3]/main[1]/div[1]/div[2]/div[1]/div[1]")).getText();
////		Assert.assertEquals( CheckLogin, "Incorrect username or password.");	
//		
//		}
//	@Test
...
// Nhập giá trị
	...
	lg.login(emailorusername, password);
	urlsuccess = driver.getCurrentUrl();
	Assert.assertEquals( urlsuccess, "https://github.com/");
